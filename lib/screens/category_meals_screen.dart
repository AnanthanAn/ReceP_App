...
class CategoryMealsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(appBar: AppBar(title: Text(screenTitle),),
    body: ListView.builder(itemBuilder: (context,index){
      return MealsItem(title: selectedMeals[index].title, imageUrl: selectedMeals[index].imageUrl,duration: selectedMeals[index].duration,);
